...
describe('user journey to request energy contract', () => {
  ...
  describe('start', () => {
    ...
    it('user nabigates to eneco main page', async () => {
    ...
    it('user fulfill "Bereken" step', async () => {
    ...
    it('user fulfill "Aanbod" step', async () => {
    ...
    it('user fulfill "Gegevens" step', async () => {
      const soonDate = toLocaleDateString(faker.date.soon({ days: 30 }));
    ...
    it('user finish at "Controle" step', async () => {
